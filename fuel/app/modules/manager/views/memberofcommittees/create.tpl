        ...
        <div class="col-lg-8 col-xs-8" style="margin-left: 16.66666667%">
            <div class="box box-success box-solid">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label class="col-md-2 col-md-offset-1"  style="text-align: left" for="member attributes">会員名称</label>
                        <div class="col-sm-8">
                            [+if isset($dataBaseofmember['name_member'])+]
                                <input type="text" name="name" class="form-control" id="name_member" value="[+$dataBaseofmember['name_member']+]" placeholder="会員名称" />
                            [+else+]
                                <input type="text" name="name" class="form-control" id="name_member" value="[+$dataBaseofmember['name_member']+]" placeholder="会員名称" />
                            [+/if+]
                        </div>
                    ...
                    <div class="form-group">
                        <label class="col-md-2 col-md-offset-1"  style="text-align: left" for="name_member_kana">会員名称(ふりがな)</label>
                        <div class="col-sm-8">
                        ...
                        <div class="col-md-6">
                            [+if isset($dataDelegate)+]
                                [+foreach $dataDelegate as $item+]
                                    ...
                                    [+else+]
                                        <label class="col-md-12"  style="text-align: left" for="member attributes">所属・役職</label>
                                    [+/if+]
                                    [+if ($item->name != NULL)+]
                                        <label class="col-md-4"  style="text-align: left" for="member attributes">氏12名</label>
                                        <label class="col-md-8"  style="text-align: left" for="member attributes">[+$item->name+]</label>
                                    [+else+]
                                        <label class="col-md-12"  style="text-align: left" for="member attributes">氏1名</label>
                                    [+/if+]
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 col-md-offset-5 ">
                            ...
                            <button type="button" id ="submit_create" name="submit_create" class="btn btn-md btn-primary btn-lg">
                                登録
                            </button>
                        </div>
