                    ...
                    [+Form::open($formset)+]
                                ...
                                [+if isset($dataMember)+]
                                    [+foreach $dataMember as $key => $item+]
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-7">
                                                <label class="control-common-label">
                                ...
                                [+if isset($dataMember)+]
                                    [+foreach $dataMember as $key => $item+]
                                        <div class ="col-md-12 btn-first">
                                            <button type="button" id="setting_member" name="setting_member" class="btn btn-primary col-md-12 " style="float: right;">会員を変更する
                                            </button>
                                        </div>
                                        <div class ="col-md-12 btn-after">
                                            <a href="[+Uri::base()+]manager/members/temp/[+$item->id+]"  style="float: right;" class="btn btn-primary col-md-12">会員情報を編集する</a>
                                        </div>
                                        <div class ="col-md-12 btn-after">
                                            <button type="button" id="delete_member" name="delete_member" class="btn btn-primary col-md-12 " style="float: right;">会員を解除する
                                            </button>
                                        </div>
                                    [+/foreach+]
                                [+else+]
                                    <div class ="col-md-12 btn-after" style="margin-top: 10%;">
                                        <button type="button" id="setting_member" name="setting_member" class="btn btn-primary col-md-12 " style="float: right; ">会員をセットする
                                        </button>
                                    </div>
                                [+/if+]
                            </div>
                                ...
                                <div class ="col-md-12">
                                    ...
                                    [+if isset($dataMemberofcommittees['request_of_cost'])+]
                                        [+if ($dataMemberofcommittees['request_of_cost'] == 0)+]
                                            <div class="col-md-8 request-of-cost" style="padding-left: 7.333%">
                                ...
                                <div class ="col-md-12">
                                    [+if isset($dataCommitteeOld)+]
                                        [+for $group=1 to 9+]
                                            ...
                                            [+if ($dataCommitteeOld[0][$temp_name] != NULL)&&($dataCommitteeOld[0][$temp_type] != 0) &&($dataCommitteeOld[0][$temp_selectable] != 0)+]
                                                <div class="col-md-4 col-md-offset-1" style="">
                                                    <label>[+(strlen($dataCommitteeOld[0][$temp_name]) > 25) ? Str::truncate($dataCommitteeOld[0][$temp_name], 20, '...') : $dataCommitteeOld[0][$temp_name]+]</label>
                                                </div>
                        ...
                        <div class="form-group">
                                ...
                                <div class ="col-md-12">
                                    <div class="col-md-3 col-md-offset-1" style="">
                                        ...
                                        [+if isset($dataCommittee)+]
                                            [+foreach $dataCommittee as $key => $item+]
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-12" style="">
                                                        ...
                                                        <div class="col-md-7">
                                                            <label class="control">[+(strlen($item->email) > 25) ? Str::truncate($item->email, 20, '...') : $item->email+]</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12" style="">
                                                        <div class="col-md-5">
                                            ...
                                            [+/foreach+]
                                        [+else+]
                                            <div class="col-md-8" style="padding-top: 10px; margin-left: -30px">
                                                    <div class="col-md-12" style="">
                                                        <div class="col-md-5">
                                                            <label class="control">所属・役職</label>
                                                        </div>
                            ...
                            <div class ="col-md-3">
                                [+if isset($dataCommittee)+]
                                     [+foreach $dataCommittee as $key => $item+]
                                    <div class ="col-md-12 btn-first">
                                        <button type="button" id="setting_committee" name="setting_committee" class="btn btn-primary col-md-12 " style="float: right;">メンバーを変更する
                                        </button>
                                    </div>
                                    <div class ="col-md-12 btn-after">
                                        <a href="[+Uri::base()+]manager/persons/editinfo/[+$item->id+]"  style="float: right;" class="btn btn-primary col-md-12">メンバー情報を編集す</a>
                                    </div>
                                    <div class ="col-md-12 btn-after">
                                        <button type="button" id="delete_committee" name="delete_committee" class="btn btn-primary col-md-12 " style="float: right;">メンバーを解除する
                                        </button>
                                    </div>
                                    [+/foreach+]
                                [+else+]
                                    <div class ="col-md-12 btn-first">
                                        <button type="button" id="setting_committee" name="setting_committee" class="btn btn-primary col-md-12 " style="float: right;">メンバーをセットする
                                        </button>
                                    </div>
                                [+/if+]
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-2 col-md-offset-4">
                                ...
                                [+/if+]
                                <button type="button" id ="submit_deletemember" name="submit_deletemember" class="btn btn-md btn-primary ">
                                    削除
                                </button>
                            </div>
                             <div class="col-md-2">
                                <button type="button" id ="submit_editmember" name="submit_editmember" class="btn btn-md btn-primary ">
                                    登録
                                </button>
                            </div>
                        </div>
...
<!-- /.content -->
[+Asset::js(array('membermanage/memberofcommittee_editmember.js'))+]