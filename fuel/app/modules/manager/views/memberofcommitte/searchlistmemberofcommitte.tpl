	...
	<div class="row">
		<div class="col-md-12">
			<div class="box box-success box-solid">
				...
				<div class="box-body">
					<a class="btn btn-primary" style="margin-left: 10%; margin-bottom: 20px; width: 6%; height: 5%;" href='manager/memberofcommitte/index'>
						<span>戻る</span>
					</a>
							...
							<table class="table table-hover">
								<tbody>
									...
									<tr>
										...
										<td width="130px">[+(strlen($item['member_edit']) > 13) ? Str::truncate($item['member_edit'], 10, '...') : $item['member_edit']+]</td>
										<td width="110px">[+(strlen($item['member_note']) > 13) ? Str::truncate($item['member_note'], 10, '...') : $item['member_note']+]</td>
									</tr>
									[+$i = $i + 1+]
									[+/foreach +]
								</tbody>
