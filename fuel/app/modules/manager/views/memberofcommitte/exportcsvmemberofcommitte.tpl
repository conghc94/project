			...
			<div class="box box-success box-solid">
				...
				<div class="box-body">
					[+assign var = formset value = [
						...
						'id'	 => 'submitSearch',
						'action' => 'manager/memberofcommitte/exportcsvmemberofcommitte'
					]+]
					[+Form::open($formset)+]

						<div class="form-group">
							<div class="col-md-6 col-md-offset-3 control-common-label text-right" style="font-weight: bold;">
								CSV出力する内容を選択してください。
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-6 col-md-offset-3 control-common-label text-right">
						...
						<div class="form-group">
							<label class="col-md-2 col-md-offset-3 control-common-label text-right">ソート順</label>
							<div class="col-md-4">
						...
						<div class="form-group">
							<div class="col-md-4 col-md-offset-5">
								<input type="submit" name="submit" class="btn btn-md btn-primary" id="exportCSV" style="width: 40%;" value="検索"/> 
							</div>
						</div> 
					[+Form::close()+]
