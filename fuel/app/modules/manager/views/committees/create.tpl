            ...
            <div class="box box-primary box-solid">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-xs-3 col-xs-offset-1 padding-left-50" for="member_name">会員名称</label>
                            <div class="col-xs-7">
                        ...
                        <!--氏名(ふりがな): Name kana-->
                        <div class="form-group">
                            <label class="col-xs-3 col-xs-offset-1 padding-left-50" " for="name_kana">氏名(ふりがな)</label>
                            <div class="col-xs-7">
                        ...
                        <!--メール: email -->
                        <div class="form-group">
                            <label class="col-xs-3 col-xs-offset-1 padding-left-50" " for="email">メール</label>
                            <div class="col-xs-7">
                        ...
                        <!--電話: telephone -->
                        <div class="form-group">
                            <label class="col-xs-3 col-xs-offset-1 padding-left-50" " for="tel">電話</label>
                            <div class="col-xs-7">
                        ...
                        <!--FAX: fax -->
                        <div class="form-group">
                            <label class="col-xs-3 col-xs-offset-1 padding-left-50" " for="fax">FAX</label>
                            <div class="col-xs-7">
                        ...
                        <!--郵便番号: zip -->
                        <div class="form-group">
                            <label class="col-xs-3 col-xs-offset-1 padding-left-50" " for="zip">郵便番号</label>
                            <div class="col-xs-7">
                        ...
                        <!--住所2: Address 1 -->
                        <div class="form-group">
                            <label class="col-xs-3 col-xs-offset-1 padding-left-50" " for="address01">住所1</label>
                            <div class="col-xs-7">
                        ...
                        <!--住所2: Address 2 -->
                        <div class="form-group">
                            <label class="col-xs-3 col-xs-offset-1 padding-left-50" " for="address02">住所2 (ビル名・階数)</label>
                            <div class="col-xs-7">
                        ...
                        <div class="form-group">
                            <label class="col-xs-3 col-xs-offset-1 padding-left-50" " for="published_site_id">会員サイトID発行</label>
                            <div class="col-xs-7">
                        ...
                        <div class="form-group">
                            <label class="col-xs-3 col-xs-offset-1 padding-left-50" " for="type_of_ml">登録MLの種別</label>
                            <div class="col-xs-7">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-2" style="margin-left: 22%;">
                            <a href="manager/memberofcommittees/settingcommitte">
                                <button type="button" class="btn btn-md btn-primary">戻る</button>
                            </a>
                        </div>

                        <div class="col-xs-7" style="margin-left: -5%;">
                            <input type="submit" id="send" name="send" form="createCommittees" class="btn btn-md btn-primary" value="入力内容を登録してメンバーとしてセットする">
                        </div>
                    </div>
                    [+Form::close()+]
                </div>
