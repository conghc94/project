...
<!--Thiết lập member uy vien hoi (S009) 2 -->
                ...
                <div class="box-body">
                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="custom_input_[+$i+]" class="form-control" id="custom_input_[+$i+]" placeholder="カスタム入力項目[+$i+]" value="[+Input::get('custom_input_[+$i+]')+]">
                            </div>
                        </div>
                        [+/for+]
                        <!--ソート順: sort ordering -->
