				...
				<div class="box-body">
					...
					[+Form::open($formset)+]
						...
						<div class="form-group">
							...
							<!--  Get data name.personss,department.persons 役員氏名 connect_type == 2 -->
							<div class="col-md-6 col-md-offset-3 control-common-label text-left">
								<label class="checkbox-inline">
									<input type="checkbox" name="repreInfoCSV" value="repreInfoCSV">役員情報
								</label>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<!-- 変更履歴コメント Get data officers.edited_history 変更履歴コメント-->
							<div class="col-md-6 col-md-offset-3 control-common-label text-left">
								<label class="checkbox-inline">
									<input type="checkbox" name="historyCommentCSV" value="historyCommentCSV">変更履歴コメント
								</label>
							</div>
							<!-- 備考 Get data officers.note 備考-->
							<div class="col-md-6 col-md-offset-3 control-common-label text-left">
								<label class="checkbox-inline">
						...
						<div class="form-group">
							<div class="col-md-4 col-md-offset-5">
								<input type="submit" name="submit" class="btn btn-md btn-primary" id="exportOfficersCSV" style="width: 40%;" value="出力"/> 
							</div>
						</div> 
					[+Form::close()+]
				</div>
