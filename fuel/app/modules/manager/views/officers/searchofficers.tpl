				...
				<div class="box-body">
					...
					[+Form::open($formset)+]
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" style="width: 80%;" class="form-control" id="nameMember" value="[+Input::get('nameMember')+]" name="nameMember">
							</div>
						</div>
						<!-- 役員氏名: nameOfficers -->
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" style="width: 80%;" class="form-control" id="nameOfficers" value="[+Input::get('nameOfficers')+]" name="nameOfficers">
							</div>
						</div>
						<!-- 担当者氏名: nameCurator -->
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" style="width: 80%;" class="form-control" id="nameCurator" value="[+Input::get('nameCurator')+]" name="nameCurator">
							</div>
						</div>
						<!-- 備考: noteOfficers -->
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" style="width: 80%;" class="form-control" id="noteOfficers" value="[+Input::get('noteOfficers')+]" name="noteOfficers">
							</div>
						</div>
						<div class="form-group">
					...
					[+/if +]
					[+if isset($officers_searchlist) && $count_sear != 0+]
							...
							<table class="table table-hover">
								<tbody>
									<tr class="tbl-header">
										...
										<th>会員名称</th>
										<!-- 登録日 : Date create base_of_members -->
										<th>登録日</th>
									</tr> 
									[+foreach $officers_searchlist as $item +]	
									<tr>
										<!-- 確認/編集 button edit officers.id -->
										<td>
											<a class="btn btn-sm btn-primary" href="manager/officers/getEdit/[+$item->officers_id+]">
												<span>確認/編集</span>
											</a>
										</td>
										<!-- NO STT -->
...
[+Asset::js(array('membermanage/searchofficers.js'))+]
