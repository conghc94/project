                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-xs-2 col-xs-offset-1 padding-left-50" for="member_name">会員名称</label>
                            <div class="col-xs-7">
                                <label name="member_name" id="member_name"></label>
                            </div>
                        </div>
                        [+/if+]
                        ...
                        <!--氏名(ふりがな): Name kana-->
                        <div class="form-group">
                            <div class="col-xs-2 col-xs-offset-1 padding-left-50" style="mar">
                        ...
                        <!--メール: email -->
                        <div class="form-group">
                            <div class="col-xs-2 col-xs-offset-1 padding-left-50">
                                <label for="email">メール</label>
                            </div>
                            <div class="col-xs-7">
                                <input type="text" name="email" class="form-control" id="email" value="[+Input::post('email')+]" placeholder="メール" />
                            </div>
                        </div>
                        <!--電話: telephone -->
                        <div class="form-group">
                            ...
                            <div class="col-xs-7">
                                <input type="text" name="tel" id="tel" class="form-control" id="tel" value="[+Input::post('tel')+]" placeholder="電話" />
                            </div>
                        </div>
                        <!--FAX: fax -->
                        <div class="form-group">
                            ...
                            <div class="col-xs-7">
                                <input type="text" name="fax" class="form-control" id="fax" value="[+Input::post('fax')+]" placeholder="FAX" />
                            </div>
                        </div>
                        <!--郵便番号: zip -->
                        <div class="form-group">
                            ...
                            <div class="col-xs-7">
                                <input type="text" name="zip" class="form-control" id="zip" value="[+Input::post('zip')+]" placeholder="郵便番号" />
                            </div>
                        </div>
                        <!--住所1: Address 1 -->                        
                        <div class="form-group">
                            <div class="col-xs-2 col-xs-offset-1 padding-left-50">
                                <label for="address01">住所1</label>
                            </div>
                            <div class="col-xs-7">
                                <input type="text" name="address01" class="form-control" id="address01" value="[+Input::post('address01')+]" placeholder="住所1" />
                            </div>
                        </div>
                        <!--住所2: Address 2 -->
                        <div class="form-group">
                            <div class="col-xs-2 col-xs-offset-1 padding-left-50">
                                <label for="address02">住所2 (ビル名・階数)</label>
                            </div>
                            <div class="col-xs-7">
                                <input type="text" name="address02" class="form-control" id="address02" value="[+Input::post('address02')+]" placeholder="住所2" />
                            </div>
                        </div>
                        <!--会員サイトID発行: Published site ID -->
                        <div class="form-group">
                            <div class="col-xs-2 col-xs-offset-1 padding-left-50">
                                <label for="name_kana">会員サイトID発行</label>
                            </div>
                            <div class="col-xs-7">
                        ...
                        <div class="form-group">
                            <div class="col-xs-2 col-xs-offset-1 padding-left-50">
                                <label for="type_of_ml">登録MLの種別</label>
                            </div>
                            <div class="col-xs-7">
                    ...
                    <div class="form-group padding-left-80">
                        ...
                        <div class="col-xs-2" style="margin-left: 16%;">
                            <a href="manager/officers/setting">
                                <button type="button" class="btn btn-md btn-primary">戻る</button>
                            </a>
                        </div>

                        <div class="col-xs-7" style="margin-left: -7%;">
                            <input type="submit" id="send" name="send" form="createOfficer" class="btn btn-md btn-primary" value="入力内容を登録して役員としてセットする">
                        </div>
                    </div>
                    [+Form::close()+]
                </div>
...
<!-- /.content  -->
[+Asset::js(array('membermanage/officer_create.js'))+]