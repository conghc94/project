<!--Màn hình tham gia cong chuc M007-01-->
                ...
                [+/if +]
                    ...
                    <div class="form-group">
                        <div class="col-xs-2 col-xs-offset-2">
                            <label class="control-common-label padding-left-50" style="text-align: left; margin-left: -15px; " for="officer attributes">RRI 役職</label>
                        </div>
                    ...
                    [+else+]
                        ...
                        <div class="col-xs-2" style="float: right; margin-right: 12%; padding-top: 1%;" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-2" style="float: right; margin-right: 16.5%;">
                            <input type="hidden" id="check_main_curator" name="check_main_curator">
                            <input type="submit" id="MainCuratorSetting" name="MainCuratorSetting" style="width: 135%" value="主担当をセットする" class="btn btn-primary col-md-12">
                        </div>
                        [+/if+]
                    </div>
...
<!-- /.content -->
[+Asset::js(array('membermanage/officer_setup.js'))+]