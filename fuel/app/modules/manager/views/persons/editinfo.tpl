                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-7">
                                <label name="member_name" id="member_name"  ">[+(strlen($item->member_name) > 50) ? Str::truncate($item->member_name, 45, '...') : $item->member_name+]</label>
                            </div>
                        </div>
                        ...
                        <!--メール: email -->
                        <div class="form-group">
                            <label class="col-xs-3 col-xs-offset-1 padding-left-50"   for="emai">メール</label>
                            <div class="col-xs-7">
                        ...
                        <!--郵便番号: Zip -->
                        <div class="form-group">
                            <label class="col-xs-3 col-xs-offset-1 padding-left-50"   for="postal_code">郵便番号</label>
                            <div class="col-xs-7">
                        ...
                        <!--住所2: Address 1 -->
                        <div class="form-group">
                            <label class="col-xs-3 col-xs-offset-1 padding-left-50"   for="address_one">住所1</label>
                            <div class="col-xs-7">
                        ...
                        <!--住所2: Address 2 -->
                        <div class="form-group">
                            <label class="col-xs-3 col-xs-offset-1 padding-left-50"   for="address_two">住所2 <br /> (ビル名・階数)</label>
                            <div class="col-xs-7">
                    ...
                    <div class="form-group" style="">
                        ...
                        <div class="col-xs-2" style="margin-left: 23%;">
