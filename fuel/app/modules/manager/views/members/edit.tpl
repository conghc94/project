                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-5">
                            ...
                            [+else+]
                                [+Form::select('type', Input::post('type'), [''=>'', '1' => '企業', '2' => '団体', '3' => '研究機関', '4' => '個人', '5' => '地方自治体'], ['class' => 'form-control'])+]
                            [+/if+]
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                         <div class="col-xs-3 col-xs-offset-1 padding-left-50">
                    ...
                    <div class="form-group">
                            ...
                            [+if isset($dataDelegate)+]
                                [+foreach $dataDelegate as $item+]
                                    <div class="col-xs-12" style="float:left">
                                        ...
                                        <div class="col-xs-7">
                                            [+if ($item->department)+]
                                            <label  style="text-align: left" for="member attributes">[+(strlen($item->department) > 25) ? Str::truncate($item->department, 20, '...') : $item->department+]</label>
                                            [+/if+]
                                        </div>
                                    </div>
                                    <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-7">
                                            [+if ($item->name)+]
                                            <label  style="text-align: left" for="member attributes">[+(strlen($item->name) > 25) ? Str::truncate($item->name, 20, '...') : $item->name+]</label>
                                            [+/if+]
                                        </div>
                                    </div>
                        ...
                        [+if isset($dataDelegate)+]
                            <div class="col-xs-12 col-xs-offset-1 padding-left-50">
                                <label class="control-common-label">担当者</label>
                            </div>
                        [+else+]
                            <div class="col-xs-12 col-xs-offset-1 padding-left-50 padding-top-60">
                                <label class="control-common-label">担当者</label>
                            </div>
                        [+/if+]
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-xs-2 col-xs-offset-1">
                            ...
                            <div class="col-md-3 btn-right-side">
                                ...
                                [+/if+]
                                [+if isset($dataMainCurator)+]
                                    <a type="button" href="[+Uri::base()+]manager/persons/editinfo/[+$items->id+]" class="btn btn-primary col-md-12 " id="editOfficer" name="editOfficer" style="float: right;margin-top: 10%;">主担当情報を編集する</a>
                                    <input type="button" id="delete_main_curator" name="delete_main_curator" form="editMember" class="btn btn-primary col-md-12 " style="float: right;margin-top: 10%;" value="主担当を解除する" />
                                [+/if+]
                            </div>
                    </div>
                        ...
                        <hr>
                            ...
                            [+for $i=0 to ($arrayNewSubCurator|@count - 1)+]
                                ...
                                [+foreach $arrayNewSubCurator[$i] as $items+]
                                    <div class="form-group">
                                        <div class="col-xs-2 col-xs-offset-1 padding-left-50 lb-required">
                                        ...
                                        <div class="col-md-3 btn-right-side">
                                            ...
                                            <a href="[+Uri::base()+]manager/persons/editinfo/[+$items->id+]"  style="float: right; margin-top: 10%;" class="btn btn-primary col-md-12">サブ担当情報を編集する</a>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2 col-md-offset-4">
                            <button type="button" id ="delete_member" name="delete_member" class="btn btn-md btn-primary col-md-8">
                                削除
                            </button>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <button type="button" id ="submit_edit" name="submit_edit" class="btn btn-md btn-primary col-md-2">
                                登録
                            </button>
                        </div>
