...
return array(
	...
	// オリジナル
	'original'                   => array(
		'wrapper'                 => "<ul class=\"pagination\" style='text-align: center;'>\n\t{pagination}\n</ul>\n",
		...
		'previous'                => "{link}",
		'previous-marker'         => "",
		'previous-link'           => "<li class=\"active\"><a href=\"{uri}\">前の200件へ&nbsp;&nbsp;</a></li>  ",

		'previous-inactive'       => "",
		'previous-inactive-link'  => "",

		'regular'                 => "{link}",
		'regular-link'            => "<span><a href=\"{uri}\">{page}</a></span>",

		'active'                  => "{link}",
		'active-link'             => "<li>{page}</li>",

		'next'                    => "{link}",
		'next-marker'             => "",
		'next-link'               => "  <li class=\"active\"><a href=\"{uri}\">次の200件へ</a></li>",
